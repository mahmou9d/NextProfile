...
export const projects = [
  {
    id: 1,
    title: { EN: "Droppz", AR: "Droppz" },
    img: "/ChatGPT Image Jun 4, 2026, 06_18_04 PM.png",
    link: "https://droppz.vercel.app/",
    description: {
      EN: "A modern fashion e-commerce store crafted to showcase clothing collections with style. Featuring a smooth shopping experience, responsive design, and optimized performance, Droppz helps customers discover and purchase apparel effortlessly.",
      AR: "متجر إلكتروني عصري للأزياء مصمم لعرض مجموعات الملابس بأسلوب احترافي. يوفر تجربة تسوق سلسة، وتصميمًا متجاوبًا، وأداءً سريعًا يساعد العملاء على استكشاف المنتجات وإتمام عمليات الشراء بسهولة.",
    },
  },
  {
    id: 2,
