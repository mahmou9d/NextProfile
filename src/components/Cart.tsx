...
const Cart = ({ project, index, locale }:{project:{id:number,img:string, title:{EN:string, AR:string}, description:{EN:string, AR:string}, link:string}, index:number, locale:string}) => {
  return (
    <article
      key={project.id}
