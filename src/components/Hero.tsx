  ...
  return (
    <>
      <style>{`
        ...
        .roi-badge-txt { font-size:15px;font-weight:700;letter-spacing:0.12em;color:rgba(167,139,250,0.95);text-transform:uppercase; }
        ...
        .roi-sub { font-size:17px;font-weight:400;line-height:1.7;color:rgba(255,255,255,0.75);margin-bottom:16px;animation:fadeUp 0.6s 0.26s both;max-width:580px; }
        .roi-ads-note { font-size:15px;font-weight:600;line-height:1.6;color:rgba(167,139,250,0.9);background:rgba(124,58,237,0.08);border:1px solid rgba(124,58,237,0.22);border-radius:12px;padding:12px 18px;margin-bottom:32px;max-width:580px;animation:fadeUp 0.6s 0.32s both; }
        ...
        .roi-inputs-title { font-size:14px;font-weight:700;letter-spacing:0.15em;text-transform:uppercase;color:rgba(255,255,255,0.75);margin-bottom:24px; }

        .roi-field { margin-bottom:20px; }
        .roi-field label { display:block;font-size:15px;font-weight:600;color:rgba(255,255,255,0.75);margin-bottom:4px; }
        .roi-field-hint { font-size:12px;color:rgba(255,255,255,0.38);margin-bottom:10px;line-height:1.5; }
        .roi-field-row { display:flex;align-items:center; }
        .roi-currency { display:flex;align-items:center;justify-content:center;width:48px;height:48px;background:rgba(255,255,255,0.05);border:1px solid rgba(255,255,255,0.1);border-left:none;border-radius:0 10px 10px 0;font-size:13px;font-weight:700;color:rgba(255,255,255,0.75);flex-shrink:0; }
        ...
        .roi-insight-lbl { font-size:12px;color:rgba(255,255,255,0.45);margin:0 0 4px; }
        ...
        .roi-card-lbl { font-size:12px;font-weight:700;letter-spacing:0.15em;text-transform:uppercase;color:rgba(255,255,255,0.75);margin-bottom:8px; }
        ...
        .roi-card-sub { font-size:13px;color:rgba(255,255,255,0.75); }
        ...
        .roi-mini-lbl { font-size:12px;font-weight:700;letter-spacing:0.12em;text-transform:uppercase;color:rgba(255,255,255,0.75);margin-bottom:6px; }
        .roi-mini-val { font-size:18px;font-weight:800;letter-spacing:-0.02em;color:rgba(255,255,255,0.75); }
        ...
        .roi-bars-title { font-size:13px;font-weight:700;letter-spacing:0.12em;text-transform:uppercase;color:rgba(255,255,255,0.75);margin-bottom:14px; }
        ...
        .roi-bar-name { font-size:14px;font-weight:600;color:rgba(255,255,255,0.75); }
        .roi-bar-num { font-size:14px;font-weight:800;color:rgba(255,255,255,0.75); }
        ...
        .roi-btn-sec { display:inline-flex;align-items:center;gap:8px;padding:14px 22px;border-radius:12px;border:1px solid rgba(255,255,255,0.1);background:transparent;color:rgba(255,255,255,0.75);font-size:14px;font-weight:600;font-family:'Cairo',sans-serif;cursor:pointer;transition:all 0.2s;white-space:nowrap;text-decoration:none; }
        ...
        .roi-trust-icon { width:16px;height:16px;border-radius:50%;background:rgba(124,58,237,0.15);border:1px solid rgba(124,58,237,0.35);display:flex;align-items:center;justify-content:center;font-size:11px;color:#a78bfa; }
        .roi-trust-txt { font-size:13px;color:rgba(255,255,255,0.75);font-weight:500; }
